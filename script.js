...
const ctx = canvas.getContext("2d"); //Получение контекста — через него можно работать с холстом
...
const objects = []; //Массив игровых объектов
const roads = []; //Массив с фонами

const player = null; //Объект, которым управляет игрок, — тут будет указан номер объекта в массиве objects
...
const player = 0; //номер объекта, которым управляет игрок
